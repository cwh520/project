...
class Admin(db.Model):
    ...
    def __repr__(self):
        return 'id=%r,account=%r,password=%r,nickname=%r,pic=%r,time=%r' %(self.id, self.account, self.password, self.nickname, self.pic, self.time)
...
class Article(db.Model):
    ...
    bfcontent = db.Column(db.String(10000), nullable=False)
